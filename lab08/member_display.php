...
<body>
    ...
    if (mysqli_num_rows($queryResult) > 0) {
        // table exists, display members.
        $query = "SELECT member_id, fname, lname FROM vipmembers ORDER BY member_id";
        ...
        echo "<tr><th>VIP#</th><th>First name</th><th>Last name</th></tr>";
